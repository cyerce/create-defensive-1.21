...
public class SuperheatedIrradiatedWaterFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> SUPERHEATED_IRRADIATED_WATER_FLUID_TYPE = register("superheated_irradiated_water_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1ffffff, new Vector3f(1f, 1f, 1f), properties));
    }
