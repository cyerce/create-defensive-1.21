...
public class EthylbenzeneFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> ETHYLBENZENE_FLUID_TYPE = register("ethylbenzene_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1daffe8, new Vector3f(218f / 255f, 1.0f, 232f / 255f), properties));
    }
