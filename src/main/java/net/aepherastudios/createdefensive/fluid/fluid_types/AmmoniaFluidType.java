...
public class AmmoniaFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> AMMONIA_FLUID_TYPE = register("ammonia_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1dda1db, new Vector3f(221f / 255f, 161f / 255f, 219f / 255f), properties));
    }
