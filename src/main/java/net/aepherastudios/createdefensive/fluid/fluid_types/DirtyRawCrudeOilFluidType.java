...
public class DirtyRawCrudeOilFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> DIRTY_RAW_CRUDE_OIL_FLUID_TYPE = register("dirty_raw_crude_oil_fluid",
