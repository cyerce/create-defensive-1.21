...
public class BenzeneFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> BENZENE_FLUID_TYPE = register("benzene_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1f1e59c, new Vector3f(241f / 255f, 229f / 255f, 156f / 255f), properties));
    }
