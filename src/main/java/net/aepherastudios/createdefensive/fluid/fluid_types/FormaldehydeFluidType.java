...
public class FormaldehydeFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> FORMALDEHYDE_FLUID_TYPE = register("formaldehyde_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA17389e4, new Vector3f(115f / 255f, 137f / 255f, 228f / 255f), properties));
    }
