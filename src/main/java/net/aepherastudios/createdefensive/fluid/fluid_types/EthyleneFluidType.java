...
public class EthyleneFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> ETHYLENE_FLUID_TYPE = register("ethylene_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1d7b9c7, new Vector3f(215f / 255f, 185f / 255f, 199f / 255f), properties));
    }
