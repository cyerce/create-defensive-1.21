...
public class PropaneFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> PROPANE_FLUID_TYPE = register("propane_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1fff9ab, new Vector3f(1.0f, 249f / 255f, 171f / 255f), properties));
    }
