...
public class IrradiatedWaterFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> IRRADIATED_WATER_FLUID_TYPE = register("irradiated_water_fluid",
