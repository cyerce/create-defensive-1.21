...
public class GasolineFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> GASOLINE_FLUID_TYPE = register("gasoline_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1e19d17, new Vector3f(1.0f, 157f / 255f, 23f / 255f), properties));
    }
