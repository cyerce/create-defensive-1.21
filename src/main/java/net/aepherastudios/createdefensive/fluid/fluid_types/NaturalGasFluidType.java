...
public class NaturalGasFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> NATURAL_GAS_FLUID_TYPE = register("natural_gas_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1A6DFFF, new Vector3f(166f / 255f, 223f / 255f, 1.0f), properties));
    }
