...
public class StyreneFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> STYRENE_FLUID_TYPE = register("styrene_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1dcddbe, new Vector3f(220f / 255f, 221f / 255f, 190f / 255f), properties));
    }
