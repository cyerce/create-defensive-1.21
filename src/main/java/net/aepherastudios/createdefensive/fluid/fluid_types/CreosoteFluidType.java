...
public class CreosoteFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> CREOSOTE_FLUID_TYPE = register("creosote_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1966537, new Vector3f(161f / 255f, 111f / 255f, 42f / 255f), properties));
    }
