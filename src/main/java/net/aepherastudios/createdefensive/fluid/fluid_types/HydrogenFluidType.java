...
public class HydrogenFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> HYDROGEN_FLUID_TYPE = register("hydrogen_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1adecff, new Vector3f(173f / 255f, 236f / 255f, 1.0f), properties));
    }
