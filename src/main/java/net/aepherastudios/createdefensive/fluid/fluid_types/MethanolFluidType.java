...
public class MethanolFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> METHANOL_FLUID_TYPE = register("methanol_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1cfb3ec, new Vector3f(207f / 255f, 179f / 255f, 236f / 255f), properties));
    }
