...
public class SulfurDichlorideFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> SULFUR_DICHLORIDE_FLUID_TYPE = register("sulfur_dichloride_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1a81a1a, new Vector3f(186f / 255f, 26f / 255f, 26f / 255f), properties));
    }
