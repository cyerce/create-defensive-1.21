...
public class CarbonMonoxideFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> CARBON_MONOXIDE_FLUID_TYPE = register("carbon_monoxide_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1c76565, new Vector3f(199f / 255f, 101f / 255f, 101f / 255f), properties));
    }
