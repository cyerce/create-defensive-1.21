...
public class ChlorineFluidType {
    ...
    public static final DeferredHolder<FluidType, FluidType> CHLORINE_FLUID_TYPE = register("chlorine_fluid",
    ...
    private static DeferredHolder<FluidType, FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(STILL_RL, FLOWING_RL, OVERLAY_RL,
                0xA1cde27a, new Vector3f(205f / 255f, 286f / 255f, 122f / 255f), properties));
    }
