...
public class ElectrumArmorEffect extends MobEffect {
    public ElectrumArmorEffect(MobEffectCategory mobEffectCategory, int color) {
    ...
    public boolean applyEffectTick(LivingEntity pLivingEntity, int pAmplifier) {
        if (!pLivingEntity.level().isClientSide()) {
            ...
            pLivingEntity.addEffect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 10, 0, false, false, false));
        }
