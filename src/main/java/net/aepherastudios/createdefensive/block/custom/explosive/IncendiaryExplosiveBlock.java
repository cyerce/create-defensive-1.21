...
public class IncendiaryExplosiveBlock extends Block {

    public IncendiaryExplosiveBlock(Properties properties) {
        super(properties);
    }
    ...
    public void wasExploded(Level level, BlockPos pos, net.minecraft.world.level.Explosion explosion) {
        if (!level.isClientSide) {
            PrimedIncendiaryExplosive primed = createPrimed(level, pos, null);
    ...
    private PrimedIncendiaryExplosive createPrimed(Level level, BlockPos pos, LivingEntity igniter) {
        PrimedIncendiaryExplosive entity = new PrimedIncendiaryExplosive(
                DefensiveEntities.PRIMED_INCENDIARY_EXPLOSIVE.get(), level
        );
